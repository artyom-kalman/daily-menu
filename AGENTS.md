...
- Telegram UX: two inline buttons — `today_menu` and morning `Присылать утром` / `Отписаться`. Opt-in/out is a toast + button flip, not a new message. No student commands. Inbound group / channel updates are ignored.

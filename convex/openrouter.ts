...
export const SYSTEM_PROMPT =
  ...
  "Тебе дают список блюд из меню. Для каждого блюда верни одно короткое " +
  "определение на русском (6–10 слов, одно предложение) и оценку остроты " +
  "от 0 до 5 (0 — совсем не острое, 5 — очень острое). " +
  "Не пиши второе предложение и не используй рекламные фразы " +
  "(«обязательно», «идеальное», «прекрасный выбор»). " +
